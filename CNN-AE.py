...
SAVE_DIR = r"D:\桌面\CNN-AE\Hydraulic parameters"  
TIME_DIR = r"D:\桌面\CNN-AE\Time"  
PLOT_DIR = r"D:\桌面\CNN-AE\Training_plot"  
MOISTURE_DIR = r"D:\桌面\CNN-AE\Moisture Content"  
LOSS_DIR = r"D:\桌面\CNN-AE\Loss"  
    ...
    try:
        ...
        for epoch in range(NUM_OUTER_LOOPS):
            ...
            param_df = pd.DataFrame({
                'u': u_values,
                'h_star': u_tensor.cpu().numpy().flatten(),
                'h_pred': h_pred.flatten(),
                'k_star': u_tensor.cpu().numpy().flatten(),
